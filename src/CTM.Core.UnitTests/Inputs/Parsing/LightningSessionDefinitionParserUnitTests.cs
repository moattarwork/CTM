...
{
    public class LightningSessionDefinitionParserUnitTests
    {
        private const string MatchedSession1 = "Overdoing it in Python Lightning";
        private const string MatchedSession2 = "Overdoing it in Python lightning";
        ...
        {
            // Given
            var sut = new LightningSessionDefinitionParser();
